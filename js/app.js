  ...
  function App(settingsParams) {
          ...
          if (dir === buttons.DOWN) {
            ...
            if (localStorage.getItem('state-iap-entitlement')) {
              var state = JSON.parse(
                localStorage.getItem('state-iap-entitlement')
              );
              if (state.selectedPlan !== null) {
                planSelected = true;
              }
            }
            if (this.settingsParams.entitlement && !planSelected) {
    ...
    this.transitionToPlayer = function(data, index) {
      ...
      if (
        ...
        switch (data[index].source) {
          case 'youtube':
            this.settingsParams.PlayerView = YouTubePlayerView;
            break;
          case 'amazon':
            this.settingsParams.PlayerView = PlayerView;
            break;
        }
        if (settingsParams.autoPlay) {
